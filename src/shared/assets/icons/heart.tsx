...
const SvgComponent = ({ width = svgIconDefaultProps.width, height = svgIconDefaultProps.height, color = svgIconDefaultProps.color, ...props }: SvgIconType) => {
  return (
    <svg width='34px' height='30px' viewBox='0 -5.37 77.646 77.646' {...props}>
      <defs>
        <linearGradient id='linear-gradient' x1='1.044' y1='0.005' x2='0.413' y2='0.749' gradientUnits='objectBoundingBox'>
          ...
          <stop offset='1' stopColor='#FF5700' />
        </linearGradient>
      </defs>
      <g id='heart_red' transform='translate(-263.982 -435.283)'>
        <g id='Group_25'>
          <path id='Path_69' d='M302.81,446.03c-.059-.106-.128-.2-.187-.307.059.1.128.2.187.307Z' fill='none' />
          <path
            id='Path_70'
