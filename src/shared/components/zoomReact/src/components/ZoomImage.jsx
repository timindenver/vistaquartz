...
const ZoomImage = ({ src, fadeDuration, top, left, isZoomed, onLoad, onDragStart, onDragEnd, onClose, onFadeOut, horizontalFlip }) => {
  return (
    <Fragment>
      <img
        ...
        style={{
          ...
          transform: horizontalFlip ? 'scaleX(-1)' : 'none',
        }}
        src={src}
        onLoad={onLoad}
